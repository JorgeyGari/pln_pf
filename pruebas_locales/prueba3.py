...
# Evaluación de veracidad con validación más permisiva
def evaluate_truthfulness(statement):
    ...
    if not respaldada:
        generated_response += "\nNota: La respuesta generada no está completamente respaldada por el contexto proporcionado, pero se ha intentado justificar."  
